(function (global, factory) {
  ...
  (global.spellingVariations = factory());
...
var spellingVariations = function (word) {
...
function analyse(word) {
	...
	// get indexes
	var UK1i = list.UK1.indexOf(word);
	var UK2i = list.UK2.indexOf(word);
	var UK3i = list.UK3.indexOf(word);
	var UK4i = list.UK4.indexOf(word);
	var US1i = list.US1.indexOf(word);
	var US2i = list.US2.indexOf(word);
	var US3i = list.US3.indexOf(word);
	var US4i = list.US4.indexOf(word);
	var UKUSi = list.UKUS.indexOf(word);


	// find the nearest UK and US index
	var UKi = !!~UK1i ? UK1i : !!~UK2i ? UK2i : !!~UK3i ? UK3i : !!~UK4i ? UK4i : !!~UKUSi ? UKUSi : false;
	var USi = !!~US1i ? US1i : !!~US2i ? US2i : !!~US3i ? US3i : !!~US4i ? US4i : !!~UKUSi ? UKUSi : false;
	...
	result.variations = removeDuplicates(filterOut(result.UKVariations.concat( result.USVariations,[result.commonVariation]),word));
	result.hasVariations = !!result.variations.length;
	return result;
}

function filterOut(arr,word){
	return arr.filter(function (x){ return x&&x!==word; });
}
